...
const TCHAR* const kUrlUpdateCheck =
    _T("http://192.168.178.5:9090/service/update2");
...
const TCHAR* const kUrlCrashReport =
    _T("http://192.168.178.5:9090/cr/report");

// More information url.
// Must allow query parameters to be appended to it.
const TCHAR* const kUrlMoreInfo =
    _T("http://192.168.178.5:9090/support/installer/?");

// Code Red check url.
const TCHAR* const kUrlCodeRedCheck =
    _T("http://192.168.178.5:9090/service/check2");

// Usage stats url.
const TCHAR* const kUrlUsageStatsReport =
    _T("http://192.168.178.5:9090/tbproxy/usagestats");
}  // namespace omaha
